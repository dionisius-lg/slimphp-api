...
class ProductsController extends Controller {
    ...
    public function getAll(Request $req, Response $res) {
        ...
        array_push($custom_columns, "{$this->table_product_categories}.name AS product_category");
        array_push($join, "LEFT JOIN {$this->table_product_categories} ON {$this->table_product_categories}.id = {$this->table}.product_category_id");
